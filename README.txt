...
### 3. Driver
The driver receives transactions and drives stimulus to the DUT interface. It applies:
* Request vectors
* Enable signals
...
### 5. Scoreboard
The scoreboard implements a reference round-robin arbitration model. It:
